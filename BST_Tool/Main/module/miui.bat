...
adb shell cmd appops set com.miui.screenrecorder START_FOREGROUND ignore
...
adb shell cmd appops set com.miui.screenrecorder RUN_IN_BACKGROUND ignore
...
adb shell cmd appops set com.miui.screenrecorder RUN_ANY_IN_BACKGROUND ignore
...
adb shell cmd appops set com.miui.screenrecorder WAKE_LOCK ignore
