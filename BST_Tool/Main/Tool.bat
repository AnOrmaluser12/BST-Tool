...
echo       #       BST_Tool By HungHoaBinh    #                   #         Press [R] and Enter      #
...
echo.
echo   +====================================================================================================================+  
echo   +Press [A] and hit ENTER to Fix Ram Usage + Battery Drain Problems                                                   +  
echo   +Press [B] and hit ENTER to peform bg-dexopt-job                                                                     +  
echo   +Press [C] and hit ENTER to peform fstrim (Android 9 Above)                                                          +  
echo   +Press [D] and hit ENTER to peform kill-all                                                                          +  
echo   +Press [E] or type exit and hit ENTER to exit                                                                        +  
echo   +Press [F] and hit ENTER to peform compile apps (Android 9 Above)                                                    +  
...
echo   +Press [3] and hit ENTER to go to another settings - Extra Settings                                                  +  
echo   +Press [4] and hit ENTER to disable gms                                                                              +  
echo   +Press [5] and hit ENTER to enable gms                                                                               +  
echo   +Press [6] and hit ENTER to clear logs                                                                               +  
echo   +====================================================================================================================+  
